...
from sahara.plugins.cdh.v5_7_0.edp_engine import EdpOozieEngine
from sahara.plugins.cdh.v5_7_0.edp_engine import EdpSparkEngine
from sahara.plugins.cdh.v5_7_0 import versionhandler
from sahara.tests.unit import base


class VersionHandlerTestCase(base.SaharaTestCase):

    plugin_path = "sahara.plugins.cdh.v5_7_0."
