...
class DeployCDHV5110(base.SaharaTestCase):
    ...
    @mock.patch("sahara.plugins.cdh.v5_11_0.deploy.CU")
    ...
    @mock.patch("sahara.plugins.cdh.v5_11_0.deploy._start_roles")
    @mock.patch("sahara.plugins.cdh.v5_11_0.deploy.CU")
    ...
    @mock.patch("sahara.plugins.cdh.v5_11_0.deploy._finish_cluster_starting")
