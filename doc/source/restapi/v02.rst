...
.. sourcecode:: http
...

    {
        ...
        "error_message": "Cluster with name 'dev-cluster' already exists"
    }
...
400, NODE_TEMPLATE_EXISTS, "Node Template with name 'custom_user_template' already exists"
...
Errors:
    ...
    400, CLUSTER_EXISTS, "Cluster with name 'dev-cluster' already exists"
...
Errors:
    ...
    404, CLUSTER_NOT_FOUND, "Cluster with name 'dev-cluster' does not exists"
