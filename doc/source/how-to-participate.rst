...
If you want to contribute either to docs or to code, simply send us pull requests via github. We are going to migrate to Stack Forge later. You can file bugs at `EHO launchpad page <https://launchpad.net/eho>`_.
